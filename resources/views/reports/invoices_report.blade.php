            ...
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <form action="/Search_invoices" method="POST" role="search" autocomplete="off">
                        ...
                        <div class="col-lg-3">
                            <label class="rdiobox">
                                <input checked name="rdio" type="radio" value="1" id="type_div"> <span> Search by invoice type
                                </span></label>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                                <p class="mg-b-10">Specify the type of invoices</p><select class="form-control select2" name="type"
                                                                                 required>
                                    <option value="{{ $type ?? 'Specify the type of invoices' }}" selected>
                                        {{ $type ?? 'Specify the type of invoices' }}
                                    </option>
