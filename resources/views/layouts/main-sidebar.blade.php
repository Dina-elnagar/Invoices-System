			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can('List_Invoices')
							<li><a class="slide-item" href="{{ url('/' . $page='invoices') }}">List invoices</a></li>
                            @endcan
                            @can('Paid_Invoices')
                            ...
                            @endcan
                             ...
                             @can('Partial_Invoices')
                                    <li><a class="slide-item" href="{{ url('/' . $page='Invoices_Partial') }}">Partially paid invoices</a></li>
                                @endcan
                                @can('Archive_Invoices')
                                    <li><a class="slide-item" href="{{ url('/' . $page='Archive_Invoices') }}">Archive invoices</a></li>
                                @endcan
                        </ul>
					</li>
                    @endcan
