        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                <div>
                    ...
                    <p class="mg-b-0">Invoices System Dashboard</p>
                </div>
            </div>
        </div>
        <!-- /breadcrumb -->
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    ...
                                    <p class="mb-0 tx-12 text-white op-7">Number of Invoices :  {{\App\Models\invoice::where('value_status' ,2)->count()}}</p>
                                </div>
                                <span class="float-right my-auto mr-auto">
                    ...
                    <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                        {{number_format(\App\Models\Invoice::where('value_status' ,1)->sum('total'),2)}}</h4>
                                    <p class="mb-0 tx-12 text-white op-7">
                                        Number of Invoices :  {{\App\Models\invoice::where('value_status' ,1)->count()}}</p>
                                </div>
                                <span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">
                        ...
                        <div class="pb-0 mt-0">
                            <div class="d-flex">
                                <div class="">
                                    ...
                                    <p class="mb-0 tx-12 text-white op-7">
                                        Number of Invoices :  {{\App\Models\invoice::where('value_status' ,3)->count()}}
                                    </p>
                                </div>
                                <span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
        ...
        <div class="row row-sm">
                ...
                <div class="card">
                    <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mb-0">Invoices statistic ratio</h4>
            ...
            <div class="col-lg-12 col-xl-5">
                <div class="card card-dashboard-map-one">
                    <label class="main-content-label">Invoices statistic ratio</label>
